...
public class JDlgCliente extends javax.swing.JDialog {
    ...
    public JDlgCliente(java.awt.Frame parent, boolean modal) {
       ...
       public void beanView(ClienteBean clientebean) {
        jTxtIdlfs_Cliente.setText(Util.intToStr(cliente.getIdcliente()));
         jTxtLfs_Nome_completo.setText(cliente.getNome());
         jCboLfs_genero.setText(cliente.getApelido());
         jFmtLfs_cpf.setText(cliente.getCpf());
         jFmtLfs_dataNascimento.setText(Util.dateToStr(Cliente.getDataNascimento()));
         jPwdLfs_senha.setText(usuarios.getSenha());
         jFmtLfs_RG.setText(cliente.getRG());
          jTxtLfs_Cep.setSelectedIndex(cliente.getCep());
           jTxtLfs_email.setSelectedIndex(cliente.getEmail());
           jFmtLfs_telefone.setSelectedIndex(cliente.Telefone());
             jCboLfs_forma_pagamento.setText(cliente.getFormaDePagamento());
             
              jFmtLfs_dataUltimoLogin.setSelectedIndex(cliente.DataUltimoLogin());
               jTxtLfs_preferencias.setSelectedIndex(cliente.getPreferencias());
               jTxtLfs_observacoes.setSelectedIndex(cliente.getobservacoes());
                jFmtLfs_dataCadastro.setSelectedIndex(cliente.DataCadastro());
...
    }
        ...
        cliente.setNome(jTxtLfs_Nome_completo.getText());
        cliente.setGenero(jCboLfs_genero.getText());
        cliente.setCpf(jFmtLfs_cpf.getText());
         cliente.setDataNascimento( Util.strToDate( jFmtLfs_dataNascimento.getText()));
           cliente.setSenha(jPwdLfs_senha.getText());
             cliente.setRG(jFmtLfs_RG.getText());
              cliente.setCep(jTxtLfs_Cep.getText());
              cliente.setEmail(jTxtLfs_email.getText());
              cliente.setTelefone(jFmtLfs_telefone.getText());
              cliente.setFormaDePagamento(jCboLfs_forma_pagamento.getText());
              cliente.setDataUltimoLogin(jFmtLfs_dataUltimoLogin.getText());
              cliente.setPreferencias(jTxtLfs_preferencias.getText());
              cliente.setObservacoes(jTxtLfs_observacoes.getText());
              cliente.setCadastro(jFmtLfs_dataCadastro.getText());
